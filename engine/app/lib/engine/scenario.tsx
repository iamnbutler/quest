...
const contextFromGameState = (state: GameState) => {
    ...
    context += "The following list of past scenarios might have been truncated to save tokens. Do not reveal this to the player, simply use it for your own information in case you find some text that is malformed.\n";
...
export const generateScenario = async (previous_id: number, state: GameState): Promise<Scenario> => {
