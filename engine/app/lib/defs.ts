...
export const class_details = {
  Artificer: {
    name: "Artificer",
    description:
      "Makers of magic-infused objects, artificers are defined by their inventive nature.",
    subclasses: {
      alchemist: "Alchemist",
      armorer: "Armorer",
  ...
  Bard: {
    name: "Bard",
    description:
      "Whether scholar, skald, or scoundrel, a bard weaves magic through words and music.",
    subclasses: {
  ...
  "Blood Hunter": {
    name: "Blood Hunter",
    description:
      "Often feared or misunderstood, and driven by an unending drive to destroy the wicked, blood hunters are clever, arcane warriors.",
    subclasses: {
...
export const backgrounds = {
  Acolyte: {
    name: "Acolyte",
    description:
      "Served a temple and has devout connections to a specific deity.",
  },
  Charlatan: {
    name: "Charlatan",
  ...
  Entertainer: {
    name: "Entertainer",
    description:
      "Blessed with a theatrical talent, they captivate audiences with performances.",
  },
  FolkHero: {
    name: "Folk Hero",
  ...
  Hermit: {
    name: "Hermit",
    description:
      "Lived in seclusion, either for religious reasons or personal peace.",
  },
  Noble: {
    name: "Noble",
  ...
  Outlander: {
    name: "Outlander",
    description:
      "Grew up in the wilds, away from civilization and its comforts.",
  },
  Sage: {
    name: "Sage",
    description:
      "Spent much of their life learning and studying. Has extensive knowledge on a particular subject.",
  },
  Sailor: {
    name: "Sailor",
  ...
  Soldier: {
    name: "Soldier",
    description:
      "Experienced in battles and war tactics. Served a specific cause in the past.",
  },
  Urchin: {
    name: "Urchin",
  ...
  Knight: {
    name: "Knight",
    description:
      "Bears a noble title along with an oath of loyalty to a superior or order.",
  },
  Pirate: {
    name: "Pirate",
    description:
      "A swashbuckler of the seas, circumventing the law for personal gain.",
  },
  Gladiator: {
    name: "Gladiator",
    description:
      "Trained and performs in public fight shows for the amusement of others.",
  },
  Spy: {
    name: "Spy",
    description:
      "Highly skilled in espionage. Operates undercover to gather information.",
  },
  BountyHunter: {
    name: "Bounty Hunter",
  ...
  MonsterHunter: {
    name: "Monster Hunter",
    description:
      "Sports a unique set of skills in hunting down and eradicating monstrous threats.",
  },
} as const;
